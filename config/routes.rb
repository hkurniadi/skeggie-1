Rails.application.routes.draw do
  get '/' => 'pages#index', as: :home
	...
	get '/users/:username/past' => 'users#past_list', as: :past_list
	get '/cart' => 'users#cart', as: :cart
  get '/search' => 'pages#search', as: :search
  get '/search/:semester/:subject' => 'pages#search'
	get '/search/:semester/:subject/:wqb' => 'pages#search'
  get '/search/:semester/:subject/:coursenum/:sort' => 'pages#search', as: :search_exact
	get '/search/:semester/:subject/:coursenum/:sort/:wqb' => 'pages#search'
  get '/course/:semester/:subject/:coursenum/:section' => 'pages#course', as: :course_exact
  get '/course/:subject/:coursenum' => 'pages#course', as: :course_general
  get '/catalogue/:sub_l' => 'pages#catalogue', as: :catalogue
